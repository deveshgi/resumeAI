                ...
                <section className="mb-6">
                    ...
                    <div className="space-y-3">
                        {data.education.map((edu, index) => (
                            <div
                                key={index}
                                className="border-l pl-4 flex justify-between items-start"
                ...
                <section className="mb-6">
                    ...
                    <ul className="space-y-3 ">
                        {data.project.map((proj, index) => (
                            <div key={index} className="border-l pl-4 flex justify-between items-start">
                                <div>
                        ...
                        {data.experience.map((exp, index) => (
                            ...
                            >
                                <div className="flex justify-between items-start mb-2">
                                    <div>
                                        <h3 style={{ color: accentColor }} className="font-semibold text-gray-900">{exp.company}</h3>
